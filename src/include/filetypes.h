...
#define TYPE_GENERIC	TYPE(0)
#define TYPE_MESH		TYPE(1)
#define TYPE_TEXTURE		TYPE(2)
#define TYPE_MATERIAL		TYPE(3)
#define TYPE_SCENE		TYPE(4)
#define TYPE_LIGHT		TYPE(5)
#define TYPE_CAMERA		TYPE(6)
#define TYPE_ENVIRONMENT    TYPE(7)
#define TYPE_LABEL		TYPE(8)
...
typedef enum {
	...
	IFILETYPE_HX_LBLX	= TYPE_LABEL	| FORMAT(0)
} SUPPORTED_INPUT_FILETYPE;

typedef enum {
	OFILETYPE_UNKNOWN	= -1,
	OFILETYPE_TEXT		= TYPE_GENERIC	| FORMAT(0),
